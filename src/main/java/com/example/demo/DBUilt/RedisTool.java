 ...
 * redisTemplate封装
 */
@Component  //把普通pojo实例化到spring容器中 @Component @Service
public class RedisTool {
    ...
    /**
     * 用于清理所有redis外缓存的springboot的session
     * @param key
     */
    public void DelSession(String key,long Timeout){
    ...
    public Set<String> Keys(String ... keys){
        ...
        return redisTemplate.keys(stringBuilder.toString());
    }
